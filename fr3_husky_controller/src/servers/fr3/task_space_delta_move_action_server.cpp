...
#include <fr3_husky_controller/servers/fr3/task_space_delta_move_action_server.hpp>
...
REGISTER_FR3_ACTION_SERVER(TaskSpaceDeltaMove, "fr3_task_space_delta_move")
