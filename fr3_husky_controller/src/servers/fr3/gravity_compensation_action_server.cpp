#include <fr3_husky_controller/servers/fr3/gravity_compensation_action_server.hpp>
...
/*
# send goal
ros2 action send_goal /fr3_gravity_compensation fr3_husky_msgs/action/GravityCompensation \
 "{use_qp: true}"
*/