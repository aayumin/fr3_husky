#include <fr3_husky_controller/servers/fr3/keyboard_move_action_server.hpp>
...
{   
    ...
    x_target_l_ = fr3_model_updater_.robot_data_->getPose(left_controller_ee_name_);
    x_target_r_ = fr3_model_updater_.robot_data_->getPose(right_controller_ee_name_);
    x_goal_l_ = fr3_model_updater_.robot_data_->getPose(left_controller_ee_name_);
    x_goal_r_ = fr3_model_updater_.robot_data_->getPose(right_controller_ee_name_);
...
KeyboardMove::ComputeResult KeyboardMove::compute(const rclcpp::Time& time, const rclcpp::Duration& /*period*/)
{
    ...
    const double pos_step = 0.15 * fr3_model_updater_.dt_ * controller_pos_multiplier_;
    const double rot_step = 1.0 * fr3_model_updater_.dt_ * controller_ori_multiplier_;
...
REGISTER_FR3_ACTION_SERVER(KeyboardMove, "fr3_keyboard_move")
