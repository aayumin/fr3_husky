...
//PJY added----------------------------
double quintic(double time,     //< Current time
               double time_0,   //< Start time
               double time_f,   //< End time
               double x_0,      //< Start state
               double x_f,      //< End state
...
double quinticDot(double time,     //< Current time
                  double time_0,   //< Start time
                  double time_f,   //< End time
                  double x_0,      //< Start state
                  double x_f,      //< End state
...
Eigen::Matrix3d rotationQuintic(double time,
                                double time_0,
                                double time_f,
                                const Eigen::Matrix3d& rotation_0,
                                const Eigen::Matrix3d& rotation_f);

Eigen::Vector3d rotationQuinticDot(double time,
                                   double time_0,
                                   double time_f,
                                   const Eigen::Matrix3d& rotation_0, 
                                   const Eigen::Matrix3d& rotation_quintic,
                                   const Eigen::Matrix3d& rotation_f);


Eigen::Isometry3d rigidRotation(const Eigen::Vector3d& cor, 
