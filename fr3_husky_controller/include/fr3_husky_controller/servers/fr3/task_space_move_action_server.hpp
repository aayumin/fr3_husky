...
#include <fr3_husky_msgs/action/task_space_move.hpp>
...
class TaskSpaceMove final : public ActionServerBase<fr3_husky_msgs::action::TaskSpaceMove>
{
public:
    using ActionT = fr3_husky_msgs::action::TaskSpaceMove;
    ...
    TaskSpaceMove(const std::string& name, const NodePtr& node, ModelUpdaterBase& model_updater);
    ~TaskSpaceMove() override = default;
