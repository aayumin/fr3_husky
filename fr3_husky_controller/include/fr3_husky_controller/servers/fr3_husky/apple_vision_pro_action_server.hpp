...
private:
    ...
    rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr cur_pose_l_pub_, cur_pose_r_pub_;
    ...
    geometry_msgs::msg::PoseStamped affineToPoseStamped(const Eigen::Affine3d& T, const std::string& frame_id);
    ...
    double max_linear_vel_ = 0.02;   // m/s
    double max_angular_vel_ = 0.4;  // rad/s
